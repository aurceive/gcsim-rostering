...
// We keep it minimal: grow_roster needs DPS, per-character DPS, and character stats.
...
// This is intentionally decoupled from github.com/genshinsim/gcsim/pkg/model so grow_roster
